...
public class AdopetConsoleApplication {
    ...
    private static void cadastrarAbrigos() throws IOException, InterruptedException{
        ...
        HttpClient client = HttpClient.newHttpClient();
        String uri = "http://localhost:8080/abrigos";
        HttpResponse<String> response = dispararRequicaoPost(client, uri, json);
    ...
    private static void listaPetsDoAbrigo() throws IOException, InterruptedException{
    ...
    private static HttpResponse<String> dispararRequicaoPost
    (HttpClient client ,String uri, JsonObject json) throws IOException, InterruptedException{
        HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create(uri))
